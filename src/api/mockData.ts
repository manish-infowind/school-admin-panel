...
export const mockSiteSettings: SiteSettings = {
  ...
  key: 'main',
  siteName: 'Pinaypal',
  siteUrl: 'https://pinaypal.com',
  siteDescription: 'Leading payment platform',
  businessEmail: 'info@pinaypal.com',
  adminEmail: 'admin@gmail.com',
  ...
  socialMedia: {
    facebook: 'https://facebook.com/pinaypal',
    twitter: 'https://twitter.com/pinaypal',
    linkedin: 'https://linkedin.com/company/pinaypal',
    instagram: 'https://instagram.com/pinaypal',
  },
  logoUrl: '/logo.svg',
